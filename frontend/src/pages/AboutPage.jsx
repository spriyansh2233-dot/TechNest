...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-transparent text-primary py-20 px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto relative overflow-hidden mt-16">
      ...
      <div className="absolute top-[10%] left-[-15%] w-[600px] h-[600px] bg-[#8A2BE2]/5 rounded-full blur-[140px] pointer-events-none z-0" />
      <div className="absolute bottom-[15%] right-[-15%] w-[700px] h-[700px] bg-[#4f46e5]/5 rounded-full blur-[150px] pointer-events-none z-0" />
      <div className="absolute top-[40%] left-[50%] -translate-x-1/2 w-[800px] h-[400px] bg-purple-900/5 rounded-full blur-[130px] pointer-events-none z-0" />

      {/* Decorative cyber grid overlay */}
      <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.005)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.005)_1px,transparent_1px)] bg-[size:30px_30px] opacity-20 pointer-events-none z-0" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto space-y-24 md:space-y-32">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#8A2BE2]/30 bg-[#8A2BE2]/5 mb-2 backdrop-blur-sm">
            <span className="material-symbols-outlined text-[#8A2BE2] text-[16px] animate-pulse">explore</span>
          ...
          <h1 className="font-display-lg text-[38px] md:text-[58px] text-primary leading-tight font-extrabold max-w-4xl mx-auto">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-[#a855f7] to-[#8A2BE2] neon-text-glow">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feat, index) => (
              <motion.div
                ...
                className="glass-card relative overflow-hidden group flex flex-col justify-between p-8 rounded-2xl border border-white/5 bg-[#141414]/30 backdrop-blur-lg hover:border-[#8A2BE2]/40 hover:shadow-[0_0_30px_rgba(138,43,226,0.15)] transition-all duration-500 min-h-[220px]"
              >
                {/* Accent glow corner */}
                <div className="absolute -top-12 -right-12 w-24 h-24 rounded-full bg-gradient-to-br from-[#8A2BE2]/10 to-transparent blur-xl group-hover:scale-150 transition-transform duration-700" />
                
                <div className="space-y-5">
                  <div className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center group-hover:border-[#8A2BE2]/50 transition-colors duration-300">
        ...
        <section className="relative overflow-hidden py-4">
          <div className="glass-card p-10 md:p-14 text-center relative overflow-hidden rounded-3xl border border-white/5 bg-gradient-to-b from-[#141414]/40 to-[#0c0c0c]/40 backdrop-blur-md">
            {/* Glowing neon divider line */}
            <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-transparent via-[#8A2BE2]/60 to-transparent" />
            <div className="absolute bottom-0 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-[#4f46e5]/20 to-transparent" />
            
            {/* Spotlight blur */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] h-[350px] bg-[#8A2BE2]/10 rounded-full blur-[100px] pointer-events-none" />

            <div className="relative z-10 space-y-6">
              <div className="w-14 h-14 rounded-full bg-white/5 border border-white/5 flex items-center justify-center mx-auto">
                <span className="material-symbols-outlined text-[#8A2BE2] text-[32px] animate-pulse">rocket_launch</span>
              </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {stats.map((stat, index) => (
              <motion.div
                ...
                whileHover={{ y: -4 }}
                className="glass-card p-6 flex flex-col items-center justify-center text-center space-y-4 rounded-xl border border-white/5 bg-[#141414]/20 hover:border-[#8A2BE2]/30 hover:shadow-[0_0_20px_rgba(138,43,226,0.1)] transition-all duration-300"
              >
                <div className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center text-[#8A2BE2] border border-white/5">
                  <span className="material-symbols-outlined text-[20px]">{stat.icon}</span>
                </div>
                <div>
                  <h4 className="text-2xl md:text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-primary to-[#8A2BE2]">
        ...
        >
          <div className="max-w-xl mx-auto space-y-6">
            <motion.button 
              ...
              className="px-10 py-4 bg-primary text-surface font-label-caps text-label-caps uppercase rounded-xl font-bold shadow-lg shadow-white/5 transition-all flex items-center gap-3 mx-auto active:scale-95 cursor-pointer"
            >
              Explore Products
