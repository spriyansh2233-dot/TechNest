...
export default function LandingPage({ 
  ...
  const trendingProds = products ? [...products].sort((a,b) => (b.reviewCount || 0) - (a.reviewCount || 0)).slice(0, 4) : [];
  ...
  return (
    <div className="animate-fadeIn pb-24">
       ...
       <section className="relative flex items-center min-h-screen px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto overflow-hidden mt-24">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-surface via-surface/95 to-surface-container/80" />
          {/* Subtle tech grid for premium branding */}
          <div className="absolute inset-0 bg-[linear-gradient(rgba(109,93,252,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(109,93,252,0.03)_1px,transparent_1px)] bg-[size:40px_40px] opacity-60 pointer-events-none" />
          
          {/* Light neon glow orb */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[850px] h-[850px] bg-primary/5 rounded-full blur-[130px] pointer-events-none z-0" />
          {/* Light streaks */}
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div className="absolute -top-20 left-1/4 w-48 h-96 bg-primary/5 rotate-12 blur-2xl animate-pulse opacity-50" />
            <div className="absolute top-1/2 right-1/3 w-48 h-96 bg-primary/5 -rotate-12 blur-2xl animate-pulse opacity-50" />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-gutter w-full relative z-10 items-center justify-items-center">
            ...
            >
              ...
              <div className="absolute -inset-10 bg-primary/5 rounded-full blur-[70px] pointer-events-none z-0" />
              <div className="relative z-10">
                <p className="text-primary mb-4 font-semibold tracking-wider text-sm uppercase">TRENDING NOW</p>

                <h1 className="text-5xl md:text-6xl font-bold leading-tight text-on-surface">
                  The Future of <br />
                  Tech, <br />
                  <span className="text-primary">Delivered.</span>
                </h1>

                <p className="mt-6 text-on-surface-variant max-w-lg text-lg">
                ...
                <div className="flex gap-4 mt-8">
                  <motion.button 
                    whileHover={{ scale: 1.05, boxShadow: "0 4px 15px rgba(109, 93, 252, 0.3)" }}
                    whileTap={{ scale: 0.98 }}
                    transition={{ type: "spring", stiffness: 400, damping: 15 }}
                    className="px-6 py-3 bg-primary text-surface font-semibold rounded-xl hover:bg-primary/95 transition-colors shadow-lg cursor-pointer"
                  ...
                  <motion.button 
                    whileHover={{ scale: 1.05, backgroundColor: "rgba(109, 93, 252, 0.05)", borderColor: "#6D5DFC" }}
                    whileTap={{ scale: 0.98 }}
                    transition={{ type: "spring", stiffness: 400, damping: 15 }}
                    className="px-6 py-3 border border-outline-variant rounded-xl transition-colors text-primary font-semibold cursor-pointer"
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none z-0">
                ...
                <div className="absolute w-[380px] h-[380px] sm:w-[480px] sm:h-[480px] rounded-full border border-primary/10 opacity-30 animate-pulse" />
                <div className="absolute w-[500px] h-[500px] sm:w-[650px] sm:h-[650px] rounded-full border border-primary/5 opacity-20" />
                
                {/* Soft atmospheric radial gradient glows */}
                <div className="absolute w-[350px] h-[350px] sm:w-[500px] sm:h-[500px] rounded-full bg-primary/5 blur-[90px] mix-blend-multiply" />
                <div className="absolute w-[250px] h-[250px] sm:w-[400px] sm:h-[400px] rounded-full bg-primary/5 blur-[80px] mix-blend-multiply" />
              </div>
              ...
              <motion.div
                ...
                className="absolute bottom-[8%] md:bottom-[6%] left-1/2 -translate-x-1/2 w-[55%] md:w-[60%] h-[24px] bg-black rounded-[50%] pointer-events-none z-0 mix-blend-multiply"
              />
              <motion.div
                animate={{
                  scaleX: [1, 0.82, 1],
                ...
                transition={{ repeat: Infinity, duration: 6, ease: "easeInOut" }}
                className="absolute bottom-[8%] md:bottom-[6%] left-1/2 -translate-x-1/2 w-[45%] md:w-[50%] h-[18px] bg-primary rounded-[50%] pointer-events-none z-0 mix-blend-multiply"
              />
              ...
              >
                <img
                  ...
                  className="w-full h-full object-contain select-none filter drop-shadow-[0_20px_50px_rgba(0,0,0,0.15)] transition-all duration-700 hover:scale-105"
                  style={{
        ...
        <div className="w-full h-[1px] bg-gradient-to-r from-transparent via-outline to-transparent relative z-10" />
      ...
      <section className="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto py-24 relative">
        <div className="absolute top-[20%] left-[-10%] w-[350px] h-[350px] bg-primary/5 rounded-full blur-[100px] pointer-events-none z-0"></div>
        <div className="absolute bottom-[20%] right-[-10%] w-[400px] h-[400px] bg-[#8B7CFF]/5 rounded-full blur-[120px] pointer-events-none z-0"></div>

        <div className="flex flex-col md:flex-row justify-between items-end mb-12 relative z-10">
          <div>
            <h2 className="font-headline-xl text-headline-xl text-on-surface mb-2">Explore by Category</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
          {[
            ...
            <div 
              ...
              className="glass-card relative overflow-hidden h-[250px] cursor-pointer group rounded-2xl border border-outline transition-all duration-500 flex flex-col justify-between p-7 bg-surface hover:bg-surface-container"
            >
              {/* Colored border overlay on hover */}
              <div className="absolute inset-0 border border-transparent group-hover:border-2 transition-all duration-300 z-20 rounded-2xl pointer-events-none" style={{ borderColor: cat.color + '40' }} />

              {/* Card ambient blur orb */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 rounded-full blur-[60px] opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" style={{ backgroundColor: cat.color + '10' }} />

              {/* Top-Left Category Badge */}
              <div className="w-10 h-10 rounded-full bg-surface-container border border-outline flex items-center justify-center group-hover:scale-105 transition-transform duration-300 z-20">
              ...
              <div className="relative z-10 flex items-end justify-between w-full gap-4 mt-auto">
                <div className="text-left">
                  <h3 className="font-headline-lg text-[20px] text-on-surface mb-1 font-bold transition-colors">
                    {cat.name}
                  </h3>
                  <p className="font-body-md text-[13px] text-on-surface-variant group-hover:text-on-surface-variant/90 transition-colors leading-snug">
                    {cat.desc}
                  </p>
                </div>
                <div className="w-10 h-10 rounded-full border border-outline flex items-center justify-center text-primary bg-surface-container group-hover:bg-primary group-hover:text-surface group-hover:border-primary transition-all duration-300 transform group-hover:scale-105 flex-shrink-0">
      ...
      <section className="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto pb-24 pt-24">
        <div className="mb-12">
          ...
          <h2 className="font-headline-lg text-[28px] text-on-surface mb-2 font-bold">Recommended for You</h2>
      ...
      {dealsProds.length > 0 && (
        <section className="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto pb-24 pt-24 bg-error/5 relative overflow-hidden rounded-[40px] my-12 border border-error/20">
          <div className="absolute top-0 right-0 w-64 h-64 bg-error/10 rounded-full blur-[100px] pointer-events-none" />
          <div className="mb-12 relative z-10">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-error/30 bg-error/10 mb-4">
              <span className="material-symbols-outlined text-error text-[14px]" data-icon="local_fire_department">local_fire_department</span>
              <span className="font-label-caps text-[10px] text-error font-bold uppercase tracking-widest">
                Limited Time Offers
              </span>
            </div>
            <h2 className="font-headline-lg text-[28px] text-on-surface mb-2 font-bold">Deals of the Day</h2>
      ...
      {trendingProds.length > 0 && (
        <section className="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto pb-24 pt-24">
          <div className="mb-12">
            ...
            <h2 className="font-headline-lg text-[28px] text-on-surface mb-2 font-bold">Trending Now</h2>
            <p className="font-body-md text-body-md text-on-surface-variant">See what our community is loving right now.</p>
          </div>
        ...
        <section className="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto pb-24 pt-24">
          <div className="mb-12 flex justify-between items-end">
            <div>
              ...
              <h2 className="font-headline-lg text-headline-lg text-on-surface mb-2">Recently Viewed</h2>
            ...
            >
              ...
              <div className="mt-8 flex justify-end gap-4">
                ...
                <button 
                  ...
                  className="px-5 py-2.5 bg-primary text-surface hover:bg-primary/95 text-[12px] font-label-caps tracking-widest uppercase rounded-lg shadow-md hover:shadow-lg transition-all font-semibold cursor-pointer"
                >
                  Buy Now
                </button>
              </div>
